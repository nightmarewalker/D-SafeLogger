# Single-Process Benchmark Summary

- Latest session: `benchmark_20260506_180018`
- Artifacts: [`benchmarks/results/benchmark_20260506_180018/summary.md`](../results/benchmark_20260506_180018/summary.md), [`benchmarks/results/benchmark_20260506_180018/summary.json`](../results/benchmark_20260506_180018/summary.json)
- Scope: messages=100000, repeat=3, threads=8
...
- Throughput leaders across the latest 3.13/3.14 x GIL x workload x scenario cells: D-SafeLogger async 8/16, structlog sync 5/16, stdlib logging async 3/16.

### Cell Winners

| Python | GIL | Workload | Scenario | Top Throughput | Lowest p50 |
|--------|-----|----------|----------|----------------|------------|
| 3.13 | disabled | multi | json | structlog sync (38,981 msg/s) | structlog sync (194.8µs) |
| 3.13 | disabled | multi | text | structlog sync (40,970 msg/s) | structlog sync (187.3µs) |
| 3.13 | disabled | single | json | D-SafeLogger async (33,452 msg/s) | D-SafeLogger async (23.4µs) |
| 3.13 | disabled | single | text | D-SafeLogger async (32,895 msg/s) | D-SafeLogger async (24.7µs) |
| 3.13 | enabled | multi | json | structlog sync (10,851 msg/s) | structlog sync (138.5µs) |
| 3.13 | enabled | multi | text | structlog sync (12,022 msg/s) | structlog sync (98.2µs) |
| 3.13 | enabled | single | json | stdlib logging async (34,572 msg/s) | D-SafeLogger async (20.8µs) |
| 3.13 | enabled | single | text | D-SafeLogger async (34,871 msg/s) | D-SafeLogger async (20.7µs) |
| 3.14 | disabled | multi | json | structlog sync (42,383 msg/s) | D-SafeLogger async (177.4µs) |
| 3.14 | disabled | multi | text | D-SafeLogger async (42,178 msg/s) | D-SafeLogger async (175.8µs) |
| 3.14 | disabled | single | json | D-SafeLogger async (42,816 msg/s) | D-SafeLogger async (19.3µs) |
| 3.14 | disabled | single | text | D-SafeLogger async (38,613 msg/s) | D-SafeLogger async (20.7µs) |
| 3.14 | enabled | multi | json | stdlib logging async (42,658 msg/s) | D-SafeLogger async (18.1µs) |
| 3.14 | enabled | multi | text | stdlib logging async (42,702 msg/s) | D-SafeLogger async (18.0µs) |
| 3.14 | enabled | single | json | D-SafeLogger async (52,081 msg/s) | D-SafeLogger async (16.7µs) |
| 3.14 | enabled | single | text | D-SafeLogger async (51,554 msg/s) | D-SafeLogger async (16.7µs) |

### D-SafeLogger Position

- Best D-SafeLogger mode beat all non-D-SafeLogger backends on throughput in 8/16 cells.
- Best D-SafeLogger mode achieved the lowest p50 in 12/16 cells.
...
- Manifest key: `single_process`
- Selected session: `benchmark_20260506_180018`
- Session artifacts: [`benchmarks/results/benchmark_20260506_180018/summary.md`](../results/benchmark_20260506_180018/summary.md), [`benchmarks/results/benchmark_20260506_180018/summary.json`](../results/benchmark_20260506_180018/summary.json)
