...
|---|---|---|---|---|---|---|---|---|---|
| 最新 release 日 | （v23k / 0.2.1、本レポート時点） | Python 3.14 | 2024-12-06 | 2025-10-27 | 2024-09-13（GitHub） | 2026-05-07 | — | （4.32.1） | （1.41.1） |
...
- v23k ローカル検証（Python 3.14.3 / Windows）: **658 passed, 3 skipped**（収集 661、`uv run pytest tests -v`）
